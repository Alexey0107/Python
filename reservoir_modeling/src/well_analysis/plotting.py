...
from ..inflow_performance import InflowWell
from ..outflow_performance import VLPModel
import os
...
def plot_combined(ipr_well: InflowWell, vlp_model: VLPModel, q_max = 300):
    ...
    # output_dir = "C:/Users/admin/Python/reservoir_modeling/reservoir_data/output"
    # os.makedirs(output_dir, exist_ok=True)

    # # Сохраняем график
    # plt.savefig(f"{output_dir}/ipr_vlp_plot.png")
    # print(f"График сохранен в {output_dir}")

    output_dir = "/app/data/output"  # Путь внутри контейнера
    os.makedirs(output_dir, exist_ok=True)
    save_path = os.path.join(output_dir, "ipr_vlp_plot.png")

    print(f"[DEBUG] Сохранение графика в: {save_path}")  # Логирование
